        ...
        <div className="rounded-tl-0 rounded-tr-0 relative h-fill ">
          <ul className="flex flex-col p-0 m-0 list-none">
            <li className="relative flex flex-col list-none px-2 ">
              <a
                href="#"
                className=" px-[0.9375rem] py-[1.25rem] rounded-[2rem]  font-medium inline-block  relative no-underline"
              >
                <Link to="/dashboard">
                  <i class="fa-solid fa-square-poll-horizontal text-[#737B8B] text-[1.5rem]"></i>
                </Link>
                <span>
                  <Link
                    to="/dashboard"
                    className="hidden lg:inline-block text-[#737B8B] decoration-none text-[1rem]  no-underline px-[0.9375rem] hover:text-[#216fed]"
                  >
                    Dashboard
                  </Link>
                </span>
            ...
            <li className="relative flex flex-col list-none px-2 ">
              ...
              >
                <Link to="/adduser">
                  <i class="fa-solid fa-plus text-[#737B8B] text-[1.5rem]"></i>
                </Link>
                <span>
                  <Link
                    to="/adduser"
                    className="hidden text-[#737B8B] lg:inline-block decoration-none text-[1rem]  no-underline px-[0.9375rem] hover:text-[#216fed]"
                  >
                    Cars
                  </Link>
                </span>
            ...
            <li className="relative flex flex-col list-none px-2 ">
              <a
                ...
                className=" px-[0.9375rem] py-[1.25rem] rounded-[2rem]  font-medium inline-block text-[#737B8B] relative no-underline"
              >
                <i class="fa-solid fa-arrow-right-from-bracket text-[#737B8B] text-[1.5rem]"></i>
                <span className="hidden lg:inline-block decoration-none text-[1rem]  text-[#737B8B] px-[0.9375rem] hover:text-[#216fed]">
                  Logout
                </span>
              </a>
            </li>
